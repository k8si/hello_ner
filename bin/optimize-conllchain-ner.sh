...
# Hyperparameter optimization for ConllChainNer
...
trainf=/iesl/data/conll/2003/eng.train
testf=/iesl/data/conll/2003/eng.testa

model="ConllChainNer.factorie" #filename the serialized model will be saved to

java -classpath $factoriejar:$CP -Xmx$MEMORY cc.factorie.app.nlp.ner.ConllNerOptimizer --train=$trainf --test=$testf --save-model=$model --serialize=true
